...
?>
    ...
    <html>
        ...
        <body>
            ...
            <div class="container">
                <h1 class="text-center">Actualizar Datos de Alumno</h1>
                <form action="actualizarUsuario.php"  method="post">  
                        <div class="container">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $fila["nombre_usuario"];?>" class="form-control" name="nombre"><br>
                            </div>

                            <div class="form-group">
                                <label for="apellido" >Apellidos del Alumno:</label><br>
                                <input type="text" value="<?php echo $fila["apellidos_usuario"];?>" class="form-control"  name="apellido"><br>
                            </div>
